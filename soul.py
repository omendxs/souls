...
FORWARD_CHANNEL_ID = -1002368062743
CHANNEL_ID = -1002368062743
error_channel_id = -1002368062743
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/*", parse_mode='Markdown')
